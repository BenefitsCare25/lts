...
- `STMicroelectronics - Placement Slips 2026_workingfile.xls` — full complexity (7 products, 6 benefit groups with compound predicates, 3 PolicyEntities, stacked Plan C/D, Flex tiers, Generali pool). Drives most of v2's schema additions. Acceptance scenario 3.
