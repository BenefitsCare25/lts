...
export function buildProductUserPrompt(
  ...
  return [
    ...
    '    When categories have DIFFERENT multipliers (e.g. Board of Directors = 36×, All Others = 24×),',
    '    set `schedule.multiplier = null` on the plan. Also emit `multiplier` on each category (see below).',
