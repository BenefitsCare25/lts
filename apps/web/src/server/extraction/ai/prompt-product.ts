...
export function buildProductUserPrompt(
  ...
  return [
    ...
    'description. Some slips label Basis of Cover rows as "Plan A: Hay Job Grade 16 and above":',
    ...
    '**Do NOT emit two plans for the same tier** — one with `rawCode = "Plan A: Hay Job Grade 16 and',
    'above"` and another with `rawCode = "A"`. That produces duplicate plans.',
    '',
