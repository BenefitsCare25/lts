...
**Source:** Anonymized from Papua New Guinea High Commission's real placement slip dated 2026.
...
- **All 7 products on a single benefit year.** Period of Insurance = 01/05/2026 – 30/04/2027 on every sheet (including the summary). No multi-year ambiguity here, unlike CBRE MCST's 2-year-billed-annually case.
