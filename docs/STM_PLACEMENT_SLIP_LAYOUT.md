...
Schema for `[REDACTED] - Placement Slips 2026_workingfile.xls` — the canonical reference for the v2 §9 STM acceptance scenario (7 products, 6 benefit groups, 3 PolicyEntities).
