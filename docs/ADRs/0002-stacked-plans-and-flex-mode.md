...
The STMicroelectronics 2026 placement slip exercised four product-modelling capabilities that the v1 brief's schema didn't support. Each one is on the critical path for parsing STM cleanly (acceptance test in `docs/PHASE_1_BUILD_PLAN_v2.md` §9, scenario 3):
